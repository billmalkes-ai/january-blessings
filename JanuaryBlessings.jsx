...
const days = [
  {
    ...
    prayer: ["Lord, you planted the garden before we arrived to eat from it.", "Receive our thanks for the beauty and provision on this table tonight. Amen."]
  },
  {
    day: 2, arc: "In the Beginning, Food", theme: "Every Seed-Bearing Plant", reference: "Genesis 1:29–30",
    ...
    prayer: ["You prepared this gift before we knew we needed it.", "We receive it tonight with gratitude that goes all the way back to the beginning. Amen."]
  },
  {
    day: 3, arc: "In the Beginning, Food", theme: "The Work of Tending", reference: "Genesis 2:15",
    ...
    prayer: ["Thank you for the farmers, the workers, and the hands that prepared this food.", "And thank you for the ground that made all of it possible. Amen."]
  },
  {
    day: 4, arc: "In the Beginning, Food", theme: "God Saw That It Was Good", reference: "Genesis 1:31",
    ...
    prayer: ["You made this world and called it very good.", "We sit at this table inside that goodness tonight. Amen."]
  },
  {
    day: 5, arc: "In the Beginning, Food", theme: "The River That Watered the Garden", reference: "Genesis 2:10",
    ...
    prayer: ["You designed provision into the world before we arrived to need it.", "Teach us to trust a God who plans that far ahead. Amen."]
  },
  {
    day: 6, arc: "In the Beginning, Food", theme: "He Rested From His Work", reference: "Genesis 2:2–3",
    ...
    prayer: ["You finished the work of provision and then rested.", "Let this table be a place of rest tonight, not just sustenance. Amen."]
  },
  {
    day: 7, arc: "The Names of God Who Gives", theme: "God Almighty", reference: "Genesis 17:1",
    ...
    prayer: ["You are El Shaddai, the God who is more than enough.", "We eat tonight from the abundance of that name. Amen."]
  },
  {
    day: 8, arc: "The Names of God Who Gives", theme: "The Lord Will Provide", reference: "Genesis 22:13–14",
    ...
    prayer: ["You provided for Abraham before he reached the moment of need.", "Give us the same confidence as we sit at this table tonight. Amen."]
  },
  {
    day: 9, arc: "The Names of God Who Gives", theme: "The Lord Is My Shepherd", reference: "Psalm 23:1–2",
    ...
    prayer: ["You are our shepherd and we lack nothing.", "Lead us beside quiet waters tonight and let us rest in that. Amen."]
  },
  {
    day: 10, arc: "The Names of God Who Gives", theme: "He Opens His Hand", reference: "Psalm 145:15–16",
    ...
    prayer: ["You open your hand and satisfy every living thing.", "We look to you tonight as this psalm says all creatures do. Amen."]
  },
  {
    day: 11, arc: "The Names of God Who Gives", theme: "The God Who Sees", reference: "Genesis 16:13",
    ...
    prayer: ["You are the God who sees, even in the wilderness.", "We are grateful to be seen tonight, and to have food to eat. Amen."]
  },
  {
    day: 12, arc: "The Names of God Who Gives", theme: "He Satisfies With Good Things", reference: "Psalm 103:1–2, 5",
    ...
    prayer: ["You satisfy our desires with good things.", "We praise you tonight with all that is within us. Amen."]
  },
  {
    day: 13, arc: "When the Cupboard Looks Empty", theme: "God Himself Will Provide", reference: "Genesis 22:1–2, 8",
    ...
    prayer: ["God himself will provide — Abraham said it before he could see it.", "We say it tonight at this table, with the same confidence. Amen."]
  },
  {
    day: 14, arc: "When the Cupboard Looks Empty", theme: "A Hundredfold in Famine Ground", reference: "Genesis 26:1–3, 12",
    ...
    prayer: ["You produced a hundredfold harvest from famine ground.", "Strengthen our faith to plant in whatever land you place us. Amen."]
  },
  {
    day: 15, arc: "When the Cupboard Looks Empty", theme: "Food to Eat and Clothes to Wear", reference: "Genesis 28:20–22",
    ...
    prayer: ["You met Jacob at his most basic need — food to eat and clothes to wear.", "We are grateful tonight that you still answer prayers that simple. Amen."]
  },
  {
    day: 16, arc: "When the Cupboard Looks Empty", theme: "The Storehouses of God", reference: "Genesis 41:53–54, 57",
    ...
    prayer: ["You fed nations through Joseph's faithfulness in a prison cell.", "Let our obedience tonight be an act of trust in your larger purposes. Amen."]
  },
  {
    day: 17, arc: "When the Cupboard Looks Empty", theme: "The Jar That Lasted Three Years", reference: "1 Kings 17:12–14",
    ...
    prayer: ["You kept a widow's jar full for three years on the strength of one act of trust.", "Make us people who give first and trust you for what follows. Amen."]
  },
  {
    day: 18, arc: "When the Cupboard Looks Empty", theme: "Eyes Opened in the Desert", reference: "Genesis 21:17–19",
    ...
    prayer: ["You opened Hagar's eyes to water that was already there.", "Open our eyes tonight to provision we may be too worried to see. Amen."]
  },
  {
    ...
    framing: "Jesus made the Father's generosity the argument for persistence in prayer. A good father gives good gifts to his children, and the Father in heaven gives better gifts still. The logic moves from the lesser to the greater: if human parents provide for their children, God provides with even more consistency and care.",
    prayer: ["You are a Father who gives good gifts to those who ask.", "We ask tonight with gratitude that the door has always opened. Amen."]
  },
  {
    ...
    prayer: ["You feed the sparrows and clothe the lilies without their asking.", "We are more valuable than these, and we eat tonight knowing it. Amen."]
  },
  {
    ...
    prayer: ["Tasting and seeing that you are good is what we do at this table.", "Let this meal be one more proof of a goodness we have known for years. Amen."]
  },
  {
    ...
    prayer: ["You prepare a table even in difficult circumstances.", "Our cup overflows tonight, and we receive it with full awareness of that gift. Amen."]
  },
  {
    ...
    prayer: ["You give food to the hungry and set prisoners free.", "We receive this meal as people who depend on your character, not our own resources. Amen."]
  },
  {
    ...
    prayer: ["You satisfy the thirsty and fill the hungry with good things.", "This table tonight is one more instance of your unfailing love. Amen."]
  },
  {
    ...
    prayer: ["All creatures look to you, and you satisfy them with good things.", "We are among those creatures tonight, grateful for an open hand. Amen."]
  },
  {
    ...
    prayer: ["We eat tonight knowing that bread alone is not the whole answer.", "Feed us with your Word as well as with this food. Amen."]
  },
  {
    ...
    prayer: ["You are the bread of life, and every meal on this table points toward you.", "Satisfy the hunger that only you can reach tonight. Amen."]
  },
  {
    ...
    prayer: ["You gave yourself as bread for the life of the world.", "We do not eat tonight without knowing what that giving cost. Amen."]
  },
  {
    ...
    prayer: ["You set a table that requires nothing from us but the willingness to come.", "We come tonight, thirsty and grateful, and we eat what is good. Amen."]
  },
  {
    ...
    framing: "The Word became flesh, which means God took on a body that needed to eat, drink, sleep, and be fed by others. He entered the full experience of human hunger and human nourishment. Every meal we share is now inhabited by a God who knows from the inside what it is to be hungry and to be fed.",
    prayer: ["You became flesh and knew hunger the way we know it.", "We eat tonight in the company of a God who has sat at a table like ours. Amen."]
  },
  {
    ...
    prayer: ["Every table we sit at is set between your promise and its fulfillment.", "Come, Lord Jesus. Until that day, we eat with hope. Amen."]
  },
];
